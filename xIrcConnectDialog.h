...
**
 ***************************************************************************/
#ifndef XIRCCONNECTDIALOG_H
#define XIRCCONNECTDIALOG_H
...
class xIrcConnectDialog : public serverConnectDialog
{
  Q_OBJECT
public:   
   xIrcConnectDialog(QWidget *parent = 0, const char *name = 0);
   ~xIrcConnectDialog();
